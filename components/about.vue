          ...
          <v-row class="justify-space-between">
            <v-col cols="12" md="7">
              <div class="subheading mb-5 mb-0" style="font-weight:400;font-family:roboto;line-height: 1.7;">
                Hello, you can call me Aziz from Indonesia.
                I am front-end developer that specializes in Vue JS Framework.
                Working at Widya Robotic as Front-End Web Developer since March 2019.
                For the sake of happiness and experience, I use my free time to build a
                social organization with a focus on providing better education for people with disabilities
            ...
            <v-col cols="12" md="4">
              <v-row class="row align-center">
                ...
                <v-col cols="6" class="subheading text-no-wrap">
                  ...
                  <div class="mb-3">linkedin.com/in/muhaziziqbal</div>
                  <div class="mb-3">github.com/aziziqbal/</div>
                </v-col>
              </v-row>
            </v-col>
          </v-row>
